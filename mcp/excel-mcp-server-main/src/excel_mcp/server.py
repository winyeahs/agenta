...
def create_workbook(filepath: str) -> str:
    ...
    try:
        ...
        # 从环境变量获取下载链接前缀
        download_link_prefix = os.environ.get("DOWNLOAD_LINK", "http://127.0.0.1:8007/files/")
        
        # 构建完整的下载链接
        download_link = f"{download_link_prefix}{filename}"
        
        return f"Created workbook at {full_path}. Download link: {download_link}"
...
def run_sse():
    ...
    # Add custom route for file download
